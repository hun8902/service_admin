...
if($level_check != "1"){header("Location: /view/no_permission.php");}
if(!$object->is_login())
{
...
$object->query = "SELECT * FROM travel_expenses ORDER BY idx ASC;";
...
function menuTree($parent_id = 0)
{
    ...
    $items = '';
    $object->query = "SELECT * FROM category WHERE parent_id = '".$parent_id."'AND update_date IN (SELECT MAX(update_date) FROM category) ORDER BY id_menu ASC";
    $result = $object->get_result();
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            <nav id="nestable-menu">
                                <button class="btn btn-primary btn-sm setting_save" type="submit" id="">설정 저장</button>
                            ...
                            <button class="btn btn-primary btn-sm setting_save" type="submit" id="setting_save">설정 저장</button>
                        </form>
